	...
	<nav>
	 ...
	 <ul id='tshirts' class='dropdown-content'>
		...
		<ul id='uniform' class='dropdown-content'>
 	    ...
 	    <li><a href="#!">Hospitality Uniforms</a></li>
			<li><a href="#!">Formals</a></li>
			<li><a href="#!">Security Uniforms</a></li>
			<li><a href="#!">Miscellaneous</a></li>
