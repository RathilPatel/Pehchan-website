...
<body style="background-color:#e0e0e0;">
    ...
    <div class="parallax-container hide-on-med-and-down" style="position:relative; height:400px;">
        <div class="parallax " style="position:absolute;padding-top:5%; max-width:100%;">
            <img src="../images/uniform.jpg">
        </div>
        <img src="../images/pehchan.gif" class="animated slideInDown" img style="height:100px; width:280px; position:absolute; left:760px; top:180px;">
    </div>
    <div>
        ...
        <div class="section" style="min-height: 400px; padding-top:5%;">
            <div class="row">
                <div class="col l4 offset-s1 s10 animated slideInLeft" style="margin-bottom:5%;">
                    <div class="red lighten-4" style="height:100%; padding:35px 10px 10px 10px;">
                        <div class="white-text">
                            <img src="../images/page_icon1.png" alt=" Page Icon 1" class="pageicon">
                        </div>
                        <div class="black-text flow-text pageicondetail" style="align-item">
                            ...
                            <hr>
                            <h5 class="grey-text text-darken-1 pageicondesc">The identity of Pehchan is incomplete without the mention of t-shirts. From round to polo-necks and plain to printed, watch as we bring your design to life with our state of the art technology, extensive variety and an eye for detail making the most basic corporate T-shirts look great and feel greater.</h5>
                            <!-- <a href="#" class="btn transparent black-text" style="border-color:black; margin-bottom:10%; margin-top:10%; ">READ MORE</a> -->
                        </div>
                    </div>
                </div>
                <div class="col l4 offset-s1 s10 animated slideInLeft" style="margin-bottom:5%;">
                    <div class="lime lighten-4" style="height:100%;  padding:35px 10px 10px 10px;">
                        <div>
                            <img src="../images/page1_icon2.png" alt="Page Icon 2" class="pageicon">
                        </div>
                ...
                <div class="col l4 offset-s1 s10 animated slideInLeft" style="margin-bottom:5%;">
                    <div class="orange lighten-4" style="height:100%;  padding:35px 10px 10px 10px;">
                        <div>
                            <img src="../images/page1_icon3.png" alt="PageIcon3" class="pageicon">
                        </div>
                        <div class="black-text pageicondetail" style="align-item">
                            ...
                            <hr>
                            <h5 class="grey-text text-darken-1 pageicondesc">Gone are the days when you could congratulate a friend on a new business with a box of laddoos . Now is the time you spend your money on something more practical and less edible. With a wide range of office stationery, fancy writing instruments, desktop articles and gift sets, you'll never run out of options.
                            </h5>
                            <!-- <a href="#" class="btn transparent black-text" style="border-color:black; margin-bottom:10%; margin-top:10%; ">READ MORE</a>    -->
                        </div>
                    </div>
            ...
            <div class="row">
                ...
                <div class="col l5 offset-s1 s10 animated slideInRight">
                    ...
                    <div class="pagetiledesc flow-text">
                        <span class="black-text">With a view that you can achieve anything if you dress for it,
...
We cater to all kinds of uniform needs.
        ...
        <a href="./product.php?type=gift">
            <div class="row">
                <div class="col l5 offset-s1 s10 animated slideInLeft">
                    <div class="pagetiletitle">
                        <h4>CORPORATE GIFTING</h4>
                    </div>
                    <hr>
                    <div class="pagetiledesc">
                        <span class="black-text">Gone are the days when you could congratulate a friend on a new business
        ...
        <a href="./product.php?type=promotionalgift">
            <div class="row">
                ...
                <div class="col l5 offset-s1 s10 animated slideInRight">
                    ...
                    <hr>
                    <div class="pagetiledesc">
                        <span class="black-text"> Promote your brand using our high quality promotional merchandise with
