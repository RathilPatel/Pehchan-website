            ...
            <div class="row">
                <div class="col l4 offset-s1 s10 animated slideInLeft" style="margin-bottom:25%; margin-top:15%; ">
                    <div class="red lighten-4" style="height:100%; padding:10px 10px 10px 10px;">
                        <div class="white-text">
                            <img src="../images/page1_icon1.png" alt=" Page Icon 1" class="pageicon center">
                        </div>
                        <div class="black-text flow-text pageicondetail" style="align-item">
                            <h4 class="grey-text text-darken-3"> CUSTOMISED TSHIRTS AND UNIFORMS</h4>
                            <hr>
                ...
                <div class="col l4 offset-s1 s10 animated slideInLeft" style="margin-bottom:35%;">
                    <div class="lime lighten-4" style="height:100%;  padding:10px 10px 10px 10px;">
                        <div>
                            <img src="../images/page1_icon2.png" alt="Page Icon 2" class="pageicon">
                ...
                <div class="col l4 offset-s1 s10 animated slideInLeft" style="margin-bottom:5%;">
                    <div class="orange lighten-4" style="height:100%;  padding:10px 10px 10px 10px;">
                        <div>
                            <img src="../images/page1_icon3.png" alt="PageIcon3" class="pageicon">
